...
function Sidebar() {
  ...
  const wsList = [];
  if (cwd) {
    wsList.push({ path: cwd, name: cwd.split(/[\\/]/).pop() || cwd });
    seen.add(cwd);
  }
  for (const ws of workspaces) {
    const p2 = ws.path || ws.slug || "";
    if (p2 && !seen.has(p2)) {
      wsList.push({ path: p2, name: p2.split(/[\\/]/).pop() || p2, sessionCount: ws.session_count });
      seen.add(p2);
    }
  }
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto min-h-0", children: [
            wsList.map((ws) => {
              ...
              const displaySessions = isCurrent ? sessions : [];
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-[var(--border)] last:border-b-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `flex items-center gap-1.5 px-2 py-1.5 hover:bg-[var(--surface2)] cursor-pointer transition-colors group ${hasActiveSession ? "bg-[var(--accent)]/5" : ""}`,
                    onClick: () => {
                    ...
                    children: [
                      ...
                      ws.sessionCount !== void 0 && !isCurrent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-[var(--text3)]", children: ws.sessionCount }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          onClick: (e) => {
                ...
                isOpen && isCurrent && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-1", children: displaySessions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-8 py-2 text-[10px] text-[var(--text3)]", children: "No sessions" }) : displaySessions.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                ...
                isOpen && !isCurrent && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-8 py-2 text-[10px] text-[var(--text3)]", children: ws.sessionCount ? `${ws.sessionCount} sessions` : "Switch to view sessions" }) })
              ] }, ws.path);
            }),
