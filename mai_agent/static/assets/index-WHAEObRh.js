...
const useChatStore = create((set, get2) => ({
  ...
  addUserMessage: (text) => {
    ...
    set((s2) => ({ messages: [...s2.messages, msg] }));
    return id2;
  },
  ...
  completeStream: (turn, toolsCalled) => {
    set((s2) => ({
      messages: s2.messages.map(
        (m2) => m2.id === s2.streamingMsgId ? { ...m2, isStreaming: false } : m2
      ),
      isStreaming: false,
      streamingMsgId: null,
      turnCount: turn,
...
> ⚠️ ${message}`, isStreaming: false } : m2
        ),
        isStreaming: false,
        streamingMsgId: null
      }));
...
const useWorkspaceStore = create((set) => ({
  ...
  fetchWorkspace: async () => {
    try {
      ...
      set({
        cwd: info.cwd,
        name: info.name || info.cwd.split(/[\\/]/).pop() || "..."
      });
    } catch {
      set({ name: "Unknown" });
    }
...
function WorkspaceSelector({ collapsed }) {
  ...
  const name = useWorkspaceStore((s2) => s2.name);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { size: 15, className: "shrink-0 text-[var(--accent)]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate flex-1 text-left font-medium", children: name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 14, className: `shrink-0 transition-transform ${open ? "rotate-180" : ""}` })
        ]
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full left-0 right-0 z-30 mt-1 bg-[var(--surface)] border border-[var(--border)] rounded-lg shadow-lg max-h-[180px] overflow-y-auto animate-fade-in", children: workspaces.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-[11px] text-[var(--text3)]", children: "No saved workspaces" }) : workspaces.map((ws, i2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => {
        ...
        children: [
          "📁 ",
          ws.path || ws.slug,
          ws.session_count !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[var(--text3)] ml-2", children: [
            ws.session_count,
            " sessions"
          ] })
        ]
...
function SessionItem({ session, isActive, onClick }) {
  const timeStr = session.updated_at ? new Date(session.updated_at).toLocaleDateString(void 0, { month: "short", day: "numeric" }) : "";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick,
      className: `w-full text-left px-3 py-2.5 rounded-lg transition-colors group ${isActive ? "bg-[var(--accent)]/10 text-[var(--accent)]" : "text-[var(--text2)] hover:bg-[var(--surface2)] hover:text-[var(--text)]"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 14, className: `shrink-0 ${isActive ? "text-[var(--accent)]" : "text-[var(--text3)]"}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] font-medium truncate", children: session.session_id }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] text-[var(--text3)]", children: [
            timeStr && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: timeStr }),
...
function SessionList() {
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    return sessions.filter((s2) => s2.session_id.toLowerCase().includes(q2));
  }, [sessions, query]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1 min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 flex items-center gap-2", children: search ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "text",
        value: query,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider text-[var(--text3)] flex-1", children: "Sessions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => setSearch(true),
          className: "p-1 rounded hover:bg-[var(--surface2)] text-[var(--text3)] hover:text-[var(--text2)]",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 13 })
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-1.5 pb-2 space-y-0.5", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 text-[11px] text-[var(--text3)] text-center", children: search ? "No matching sessions" : "No sessions yet" }) : filtered.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      SessionItem,
      {
        session: s2,
        isActive: s2.session_id === currentId,
        onClick: () => handleClick(s2.session_id)
      },
      s2.session_id
    )) })
  ] });
}
function SidebarIconBar({ collapsed }) {
  ...
  const iconClass = (panel) => `p-1.5 rounded-md transition-colors ${activePanel === panel ? "text-[var(--accent)] bg-[var(--accent)]/10" : "text-[var(--text3)] hover:text-[var(--text2)] hover:bg-[var(--surface2)]"}`;
  ...
  if (collapsed) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center gap-2 px-2 py-2 border-t border-[var(--border)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: toggleSidebar, className: "p-1.5 rounded-md text-[var(--text3)] hover:text-[var(--text2)] hover:bg-[var(--surface2)]", title: "Expand sidebar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelLeft, { size: 16 }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 px-3 py-2 border-t border-[var(--border)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        title: "Memory",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { size: 16 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        title: "Skills",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 16 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        title: "Git",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(GitBranch, { size: 16 })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelLeftClose, { size: 16 })
      }
    )
  ] });
}
function Sidebar() {
  ...
  if (collapsed) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center w-[48px] bg-[var(--surface)] border-r border-[var(--border)] shrink-0 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: toggleSidebar, className: "p-1.5 rounded-md text-[var(--text3)] hover:text-[var(--text2)] hover:bg-[var(--surface2)] mb-2", title: "Expand", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleNewSession, className: "p-2 rounded-lg bg-[var(--accent)]/10 text-[var(--accent)] hover:bg-[var(--accent)]/20 transition-colors", title: "New Session", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 18 }) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col w-[260px] bg-[var(--surface)] border-r border-[var(--border)] shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-3 border-b border-[var(--border)] space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: handleNewSession,
          className: "w-full flex items-center gap-2 px-3 py-2 rounded-lg border border-[var(--border)] text-sm text-[var(--text2)] hover:text-[var(--text)] hover:border-[var(--accent)] hover:bg-[var(--accent)]/5 transition-all",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16, className: "text-[var(--accent)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "New Session" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WorkspaceSelector, { collapsed })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SessionList, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarIconBar, { collapsed })
  ] });
}
...
function ToolCard({ tool }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `my-1 bg-[var(--tool-bg)] border-l-[3px] border-[var(--border)] rounded-r-lg overflow-hidden max-w-[75%] animate-fade-in ${statusClass}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] text-[var(--text2)] font-mono truncate flex-1 min-w-0", children: args.length > 60 ? args.slice(0, 60) + "..." : args }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0", children: statusIcon })
        ]
      }
    ),
    expanded && result && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-[var(--border)] animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: `p-3 text-[12px] font-mono whitespace-pre-wrap max-h-60 overflow-y-auto ${isError ? "text-[var(--red)]" : "text-[var(--text2)]"}`, children: result.length > 3e3 ? result.slice(0, 3e3) + "\n... (truncated)" : result }) })
  ] });
}
...
function AssistantMessage({ message }) {
  ...
  if (isThinking && isStreaming && !content && (!toolCalls || toolCalls.length === 0)) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 animate-fade-in", children: [
    content && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${isStreaming ? "border-l-2 border-[var(--accent)] pl-4" : "pl-4 border-l-2 border-transparent"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MarkdownRenderer, { content }) }),
    ...
    isStreaming && /* @__PURE__ */ jsxRuntimeExports.jsx(StreamingCursor, {})
  ] });
}
...
function ChatArea({ onPromptSubmit }) {
  ...
  const handleResubmit = reactExports.useCallback((text) => {
    onPromptSubmit(text);
  }, [onPromptSubmit]);
...
function InputTextarea({ value, onChange, onSubmit, disabled }) {
  ...
  reactExports.useEffect(() => {
    ...
    const maxHeight = lineHeight * MAX_TEXTAREA_ROWS + paddingY * 2;
    const newHeight = Math.min(Math.max(el2.scrollHeight, minHeight), maxHeight);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "textarea",
    {
      ...
      disabled,
      rows: 1,
      className: "w-full bg-[var(--bg)] border border-[var(--border)] rounded-xl text-sm text-[var(--text)] px-4 py-[9px] resize-none outline-none focus:border-[var(--accent)] transition-colors placeholder:text-[var(--text3)] disabled:opacity-50 font-sans leading-snug"
    }
  );
}
...
function SendButton({ isStreaming, disabled, onClick }) {
  if (isStreaming) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        onClick,
        className: "flex items-center justify-center w-10 h-10 rounded-xl bg-[var(--red)] hover:opacity-90 text-white transition-opacity",
        title: "Stop",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick,
      disabled,
      className: "flex items-center justify-center w-10 h-10 rounded-xl bg-[var(--accent)] hover:opacity-90 text-white transition-opacity disabled:opacity-30 disabled:cursor-not-allowed",
      title: "Send",
...
function MicButton() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      onClick: handleToggle,
      className: `p-2 rounded-lg transition-colors ${active ? "text-[var(--accent)] bg-[var(--accent)]/10" : "text-[var(--text3)] hover:text-[var(--text2)] hover:bg-[var(--surface2)]"}`,
      title: "Voice input",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        className: "p-2 rounded-lg text-[var(--text3)] hover:text-[var(--text2)] hover:bg-[var(--surface2)] transition-colors",
        title: "Attach file",
...
[pasted image: ${file.name}]`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-[var(--border)] bg-[var(--surface)] p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-semibold bg-[var(--accent)]/10 text-[var(--accent)] border border-[var(--accent)]/20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { size: 10 }),
        " ",
        model
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-semibold bg-[var(--surface2)] text-[var(--text2)] border border-[var(--border)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 relative", onKeyDown: handleKeyDown, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        InputTextarea,
        {
          value,
...
function SettingsModal() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { open, onClose: close, title: t2("设置", "Settings"), maxWidth: "max-w-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PermissionSection, {}),
...
function ModelSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { label: "Model", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "select",
    {
      value: model,
...
function PermissionSection() {
  const perm = useSettingsStore((s2) => s2.permission);
  const setPerm = useSettingsStore((s2) => s2.setPermission);
  const lang = useSettingsStore((s2) => s2.language);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { label: "Permission", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: PERMISSION_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick: () => setPerm(opt.value),
      className: `flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all ${perm === opt.value ? "bg-[var(--accent)] text-white" : "bg-[var(--surface2)] text-[var(--text2)] hover:text-[var(--text)] border border-[var(--border)]"}`,
      children: opt.label[lang === "zh" ? "zh" : "en"]
    },
    opt.value
  )) }) });
}
...
function WorkspaceSection() {
  ...
  const switchWorkspace = useWorkspaceStore((s2) => s2.switchWorkspace);
  const [editing, setEditing] = reactExports.useState(false);
  const [newPath, setNewPath] = reactExports.useState(cwd);
  const handleApply = async () => {
    if (newPath.trim()) {
      try {
        await switchWorkspace(newPath.trim());
        setEditing(false);
      } catch {
      }
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { label: "Workspace", children: editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "text",
        ...
        className: "flex-1 bg-[var(--bg)] border border-[var(--border)] rounded-lg px-3 py-2 text-sm text-[var(--text)] outline-none focus:border-[var(--accent)] font-mono",
        autoFocus: true,
        onKeyDown: (e) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        onClick: handleApply,
        className: "px-3 py-2 bg-[var(--accent)] text-white rounded-lg text-sm font-medium",
        children: "Apply"
      }
    )
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 text-sm font-mono text-[var(--text2)] truncate", children: cwd || "Not set" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: () => {
        ...
        className: "flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs text-[var(--accent)] hover:bg-[var(--accent)]/10 transition-colors",
        children: [
...
function FeishuSection() {
  ...
  const hint = useSettingsStore((s2) => s2.feishuHint);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { label: "Feishu / 飞书", children: configured ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--yellow)] text-sm", children: "○ Not configured" }),
    hint && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-[var(--text3)] mt-1", children: hint }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-[var(--text3)] mt-1", children: "Set FEISHU_APP_ID and FEISHU_APP_SECRET in .env" })
  ] }) });
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex bg-[var(--bg)] text-[var(--text)]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ChatArea, { onPromptSubmit: handleSubmit }),
