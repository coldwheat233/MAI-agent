  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    ...
    showAdd && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-[var(--border)] bg-[var(--surface2)] space-y-2 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          placeholder: "Concept name (e.g. RAFT consensus)...",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          placeholder: "Context (where you encountered it)...",
          className: "w-full bg-[var(--bg)] border border-[var(--border)] rounded-md px-3 py-1.5 text-xs text-[var(--text)] outline-none focus:border-[var(--accent)]",
          onKeyDown: (e) => {
            if (e.key === "Enter") handleAdd();
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleAdd, className: "w-full py-1.5 bg-[var(--accent)] text-white rounded-md text-xs font-medium", children: "Add to Queue" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto", children: [
      pending.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        pending.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2.5 border-b border-[var(--border)] hover:bg-[var(--surface2)] transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-semibold ${priorityColor(item.priority)}`, children: item.priority }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleMarkLearned(item.id), className: "p-1 rounded text-[var(--text3)] hover:text-[var(--green)] hover:bg-[var(--surface2)]", title: "Mark learned", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 14 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleDelete(item.id), className: "p-1 rounded text-[var(--text3)] hover:text-[var(--red)] hover:bg-[var(--surface2)]", title: "Delete", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14 }) })
          ] })
        ] }) }, item.id))
      ] }),
      learned.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        learned.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2.5 border-b border-[var(--border)]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
              item.status === "synced" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-[var(--accent)] font-semibold", children: "📤 synced" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                  setEditingId(item.id);
                  setEditNotes(item.notes || "");
                }, className: "p-1 rounded text-[var(--text3)] hover:text-[var(--accent)]", title: "Add notes", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 13 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    title: "Sync to Feishu",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 13, className: syncingId === item.id ? "animate-spin" : "" })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleDelete(item.id), className: "p-1 rounded text-[var(--text3)] hover:text-[var(--red)]", title: "Delete", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 13 }) })
            ] })
          ] }),
          editingId === item.id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-1.5 animate-fade-in", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
                setEditingId(null);
                setEditNotes("");
              }, className: "px-2 py-1 text-[10px] text-[var(--text3)] hover:text-[var(--text)]", children: "Cancel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleSaveNotes(item.id), className: "px-2 py-1 text-[10px] bg-[var(--accent)] text-white rounded", children: "Save" })
            ] })
          ] })
        ] }, item.id))
      ] }),
      items.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 24, className: "mx-auto mb-2 text-[var(--border)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-[var(--text3)]", children: "No concepts in queue yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-[var(--text3)] mt-1", children: "Add concepts you encounter during development" })
      ] })
    ] })
  ] });
}
