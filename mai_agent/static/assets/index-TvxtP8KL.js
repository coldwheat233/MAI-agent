...
function Sidebar() {
  ...
  const currentWsName = cwd.split(/[\\/]/).pop() || cwd;
  ...
  const handleDeleteSession = async (id2, name) => {
    setDeleteTarget({ id: id2, name });
  };
  ...
  const addWorkspace = async (folder) => {
    try {
      await api.browseDirectory(folder);
  ...
  const handleWsContextMenu = (e, wsPath) => {
    ...
    setCtxMenu({
      ...
      y: e.clientY,
      items: [
        { label: "Switch to this workspace", onClick: () => handleSwitchWorkspace(wsPath) },
        { label: "New Session here", onClick: () => {
          handleSwitchWorkspace(wsPath).then(() => handleNewSession());
        } }
      ]
    });
  };
  const handleSessionContextMenu = (e, s2) => {
    ...
    setCtxMenu({
      ...
      y: e.clientY,
      items: [
        { label: "Load session", onClick: () => handleLoadSession(s2.session_id) },
        { label: "Delete session", onClick: () => handleDeleteSession(s2.session_id, s2.session_id), danger: true }
      ]
    });
  };
  const panelIcon = (panel, Icon2, label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick: () => activePanel === panel ? closePanel() : openPanel(panel),
      className: `p-1.5 rounded-md transition-colors ${activePanel === panel ? "text-[var(--accent)] bg-[var(--accent)]/10" : "text-[var(--text3)] hover:text-[var(--text2)] hover:bg-[var(--surface2)]"}`,
      title: label,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `flex flex-col w-[260px] bg-[var(--surface)] border-r border-[var(--border)] shrink-0 transition-colors ${dragOver ? "ring-2 ring-[var(--accent)] ring-inset" : ""}`,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-3 border-b border-[var(--border)] space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `w-full flex items-center gap-2 px-3 py-2.5 rounded-lg border-2 border-dashed text-sm transition-all ${dragOver ? "border-[var(--accent)] bg-[var(--accent)]/5 text-[var(--accent)]" : "border-[var(--border)] text-[var(--text3)] hover:border-[var(--accent)] hover:text-[var(--accent)]"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(FolderPlus, { size: 16 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: dragOver ? "Drop folder here" : "New Project" })
                ]
              }
            ),
            dragOver && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-[var(--text3)] text-center", children: "Drag a folder here to add as workspace" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-h-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => setExpanded((e) => ({ ...e, [cwd]: !e[cwd] })),
                  className: "p-0.5 rounded text-[var(--text3)] hover:text-[var(--text)]",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14, className: `transition-transform ${expanded[cwd] !== false ? "rotate-90" : ""}` })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { size: 14, className: "text-[var(--accent)] shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: "text-xs font-semibold text-[var(--text)] truncate flex-1",
                  onContextMenu: (e) => handleWsContextMenu(e, cwd),
                  children: currentWsName
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: "p-0.5 rounded text-[var(--text3)] hover:text-[var(--accent)] hover:bg-[var(--surface2)]",
                  title: "New session in current workspace",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 14 })
                }
              )
            ] }),
            expanded[cwd] !== false && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-1.5 pb-2 space-y-0.5", children: sessions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 text-[11px] text-[var(--text3)] text-center", children: "No sessions yet" }) : sessions.map((s2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => handleLoadSession(s2.session_id),
                onContextMenu: (e) => handleSessionContextMenu(e, s2),
                className: `w-full text-left px-3 py-2 rounded-lg transition-colors group ${s2.session_id === currentId ? "bg-[var(--accent)]/10 text-[var(--accent)]" : "text-[var(--text2)] hover:bg-[var(--surface2)] hover:text-[var(--text)]"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 14, className: `shrink-0 ${s2.session_id === currentId ? "text-[var(--accent)]" : "text-[var(--text3)]"}` }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] font-medium truncate", children: s2.session_id }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-[var(--text3)]", children: [
                      s2.message_count,
                      " msgs",
                      s2.updated_at && ` · ${new Date(s2.updated_at).toLocaleDateString(void 0, { month: "short", day: "numeric" })}`
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      className: "p-0.5 rounded text-[var(--text3)] hover:text-[var(--red)] opacity-0 group-hover:opacity-100 transition-opacity",
          ...
          workspaces.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-[var(--border)] px-1.5 py-1 max-h-[150px] overflow-y-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-bold uppercase tracking-wider text-[var(--text3)] px-2 py-1", children: "Other Workspaces" }),
            workspaces.filter((w2) => (w2.path || w2.slug) !== cwd).map((ws, i2) => {
              const wsPath = ws.path || ws.slug || "";
              const wsName = wsPath.split(/[\\/]/).pop() || wsPath;
              return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  onClick: () => handleSwitchWorkspace(wsPath),
                  onContextMenu: (e) => handleWsContextMenu(e, wsPath),
                  className: "w-full text-left px-3 py-1.5 rounded-md text-xs text-[var(--text2)] hover:bg-[var(--surface2)] hover:text-[var(--text)] transition-colors flex items-center gap-2",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Folder, { size: 12, className: "text-[var(--accent)] shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: wsName }),
                    ws.session_count !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[var(--text3)] ml-auto text-[10px]", children: ws.session_count })
                  ]
                }
              ) }, ws.slug || i2);
            })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 px-3 py-2 border-t border-[var(--border)]", children: [
            panelIcon("memory", Brain, "Memory"),
            panelIcon("skills", BookOpen, "Skills"),
            panelIcon("git", GitBranch, "Git"),
